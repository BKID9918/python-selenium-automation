...
class HelpPage(Page):
    ...
    def open_help_returns(self):
        self.open_page('https://help.target.com/help/SubCategoryArticle?childcat=Returns&parentcat=Returns+%26+Exchanges')
    ...
    def verify_header(self, expected_header_text):
        ...
        self.wait_for_element_to_be_visible(*header_locator)

    def verify_returns_opened(self):
        self.wait_for_element_to_be_visible(*self.HEADER_RETURNS)

    def verify_promotions_opened(self):
        self.wait_for_element_to_be_visible(*self.HEADER_PROMOTIONS)